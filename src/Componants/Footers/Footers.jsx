...
const Footers = () => {
  return (
    <div className="flex items-end w-full min-h-max ">

    <footer className="w-full text-white bg-gradient-to-r from-rose-300 to-rose-400 body-font">
        <div
            className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
              <h1 className='font-bold text-3xl'>Blog Lover</h1>
        ...
        <div className="bg-gradient-to-r from-rose-500 to-rose-500">
